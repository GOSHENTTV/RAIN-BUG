...
float3 lut_w(float3 res)
{
	...
	if (th_enable && !rd_racing) {
		float isThunder = (qWeather.x == 9.0 || qWeather.y == 9.0);
		float thunder = isThunder * th_intensity;
		thunder *= th_glow;
